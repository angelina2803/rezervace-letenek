...
const SearchForm = ({ create }) => {
  ...
  return (
    <form className="formAdd">
      ...
      ></MyInput>
      <MyButton className="myBtn" onClick={addNewPost} >Hledat <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-zoom-in" viewBox="0 0 16 16">
